   ...
   class func randomColor() -> UIColor{
    ...
    public func invertColor() -> UIColor{
        ...
        if UIColor().getRed(&r, green: &g, blue: &b, alpha: &a) {
            let ratio = (30 * r + 59 * g + 11 * b)/100
            
            if ratio <= 0.8 {return UIColor.whiteColor()}
    ...
    /**
     ...
     - parameter rgba: Whether the alpha should be included.
     */
    public func hexStringWithoutSign() -> String {
        
        return String(self.hexString(false).characters.dropFirst())
    }
